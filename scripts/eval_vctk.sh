...
EXP_NAME="vctk_white_box_ifgsm_imp"
echo "EXP_NAME = ${EXP_NAME}"
python3 eval_attack.py --data_root $DATA_ROOT --checkpoint_path pretrained_model/meta_stylespeech.pth.tar --save_dir results/${EXP_NAME} --imp_loss --momentum 1
